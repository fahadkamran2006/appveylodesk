...
export default function WorkLogsPage() {
  ...
  const handleExportAttendance = () => {
    ...
    exportToCSV(rows, `work-logs-${startDate}-to-${endDate}`);
  };
  ...
  return (
    <>
      <Helmet>
        <title>Work Logs | Veylodesk</title>
        <meta name="description" content="Track your attendance, work logs, and leave requests" />
      </Helmet>

      <DashboardLayout role="editor">
        <div className="max-w-5xl mx-auto">
          <div className="mb-6">
            <h1 className="text-2xl md:text-3xl font-bold text-foreground">Work Logs</h1>
            <p className="text-muted-foreground mt-1">Track your attendance, daily tasks, and leave requests</p>
          </div>

          {/* Attendance & Leave Action Cards */}
          {agencyId && (
