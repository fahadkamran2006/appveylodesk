  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Manage your agency projects." />
      </Helmet>
        ...
        <main className="flex-1 p-8">
          <div className="flex flex-col items-center justify-center h-full min-h-[60vh] text-center">
            ...
            <p className="text-muted-foreground max-w-md">
              Your project management hub is coming soon. You'll be able to create, 
              track, and manage all your video projects here.
            </p>
          </div>
        </main>
      </div>
