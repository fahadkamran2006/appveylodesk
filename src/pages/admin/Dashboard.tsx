...
const AdminDashboard = () => {
  ...
  const kanbanColumns = [
    { id: 'proposal', title: 'Proposals', color: 'bg-purple-500' },
                  ...
                  return (
                    <div key={column.id} className="bg-muted/30 rounded-lg p-4">
                      ...
                      <div className="space-y-3 max-h-[300px] overflow-y-auto">
                        {columnProjects.slice(0, 3).map((project) => (
                          <Link
                            key={project.id}
                            to="/admin/projects"
                            className="block p-3 rounded-lg bg-background border border-border/50 hover:border-primary/30 transition-colors"
                          >
